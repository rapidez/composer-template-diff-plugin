...
class TemplateHashUpdater
{
    public function updateVendorHashes(Composer $composer, IOInterface $io): void
    {
        $vendorDir = $composer->getConfig()->get('vendor-dir');

        if ($vendorDir === '') {
            throw new \RuntimeException('Unable to determine Composer vendor directory.');
        }
